...
class _$_LoginFormState implements _LoginFormState {
  ...
  @override
  String toString() {
    return 'LoginFormState(emailAddress: $emailAddress, password: $password, emailError: $emailError, passwordError: $passwordError, isSubmitting: $isSubmitting, showErrorMessages: $showErrorMessages, authFailureOrSuccessOption: $authFailureOrSuccessOption)';
  }
