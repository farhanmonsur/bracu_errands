...
class _$FailureTearOff {
  ...
  _Failure call({required int errorCode, required String message}) {
    return _Failure(
      errorCode: errorCode,
      message: message,
    );
...
class _$_Failure implements _Failure {
  const _$_Failure({required this.errorCode, required this.message});
...
abstract class _Failure implements Failure {
  const factory _Failure({required int errorCode, required String message}) =
      _$_Failure;
